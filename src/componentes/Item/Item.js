    ...
    return (
        <div className="w-full h-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-2 dark:border-gray-2">
            ...
            <div className="px-6 pt-4 pb-2 justify-between">
                ...
                <Link to={`/Item/${id}`} className="bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-1 rounded-full mt-4 flex items-center justify-center">Ver detalles</Link>
            </div>
        </div>
    )
}
