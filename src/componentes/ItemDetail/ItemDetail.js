...
const ItemDetail = ({name,price,category,description,img,stock}) => {
    ...
    const handleAddToCart=(amount)=>{
        ...
        addItem({name,price,category,description,img,stock},amount)
    }
        ...
        <div className="w-full h-full max-w-xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-2 dark:border-gray-2 flex items-center mx-auto">
            ...
            <div className="w-1/2 p-6">
                ...
                <div className="px-6 pt-4 pb-2 justify-between">
                    ...
                    {
                        quantityToAdd>0 ? <Link to='/cart' className='bg-blue-800 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded leading-none'>Terminar compra</Link>:
